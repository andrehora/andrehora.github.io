...
- **Lourenço Ferreira Monteiro Dias Montenegro**: Análise empírica sobre Gerenciamento de dependências usando o Dependabot
- **Ana Luisa Messias Ferreira Mendes**: Análise de Guidelines para Agentes de IA em Repositórios Open-Source
- **Lucas Silva Viana**: Análise da eficiência de LLMs na geração de Testes Unitários
- **Mateus Henrique Souza Silva**: Volatilidade de Testes de Software: Uma Análise Empírica em Repositórios Open-Source
- **Laura Godinho Barroso**: Qualidade de testes de software enviados para projetos colaborativos: Uma análise comparativa entre projetos com e sem diretrizes de contribuição

## 2025.1
- **Matheus Vaz Leal Lima**: Análise das Práticas de Testes de Software em Projetos Open Source
- **Laura Godinho Barroso**: Qualidade de testes de software enviados para projetos colaborativos: Uma análise comparativa entre projetos com e sem diretrizes de contribuição
- **Daniel Pires Quirino**: Análise das Extensões de Teste mais Utilizadas em Frameworks Modernos: Um Estudo sobre Pytest, Jest e Cypress
